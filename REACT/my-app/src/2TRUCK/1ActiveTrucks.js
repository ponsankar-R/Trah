...
function ActiveTrucks() {
  ...
  // Fetch transports when component mounts or when a new transport is added
  useEffect(() => {
        ...
        transports.map((transport, index) => (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-bold text-lg p-3 rounded-lg border-2 border-indigo-600 mb-6 text-center">
              <FaTruck className="inline-block mr-2" /> Truck Name: {transport.truck.truckName}
            </div>
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
                <div className="bg-white p-6 rounded-lg shadow-2xl max-w-lg mx-auto">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="font-bold text-gray-900">{transport.truck.truckType || 'N/A'}</div>

                    <div className="text-gray-700 font-medium">Capacity:</div>
                    <div className="font-bold text-gray-900">{transport.truck.truckCapacity || 'N/A'} kg</div>

                    <div className="text-gray-700 font-medium">Driver:</div>
                    <div className="font-bold text-gray-900">{transport.truck.driverName || 'N/A'}</div>

                    <div className="text-gray-700 font-medium">Contact:</div>
                    <div className="font-bold text-gray-900">{transport.truck.truckContact || 'N/A'}</div>
                  </div>
